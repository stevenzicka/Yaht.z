...
FUTURE PLANS: 
1. Add power-ups to the game that user can use a limited amount of times. Power-ups include roll an extra time, eliminate one dice, skip turn without 
crossing out score, etc.
2. Add a slider that allows user to turn on/off the probabilities that certain dice rolls will have using sci-kit learn. 
3. Make a leaderboard API with Node.js, Express, and MongoDB
4. Format the display to work on mobile device screens
5. Add capability to play with up to 4+ players
